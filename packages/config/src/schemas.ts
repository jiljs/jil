import {Blueprint, Schemas, schemas} from '@jil/common/optimal';
import {ExtendsSetting, FileGlob, OverridesSettingItem, PluginOptions, PluginsSetting} from './types';
 ...
 */
export function createOverridesSchema<T extends object>(blueprint: Blueprint<T>, schematics: Schemas = schemas) {
