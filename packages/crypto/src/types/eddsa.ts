...
export interface EDDSAPrivateKeyJSON extends EDDSAPublicKeyJSON, EDDSAPrivateKeyProps {}
...
export interface EDDSACtor {
  new (id: string, mid: string | null, eid: string | null, hash: HashCtor, pre?: string | string[]): EDDSA;
}
