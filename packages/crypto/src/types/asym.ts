...
export interface Adsa {
  ...
  verify(msg: string | Buffer, sig: Buffer, key: Buffer, ...extra: any[]): boolean;

  verifyMessage(msg: string | Buffer, sig: Buffer, key: Buffer, ...extra: any[]): boolean;

  verifyDigest(digest: string | Buffer, sig: Buffer, key: Buffer, ...extra: any[]): boolean;
}
