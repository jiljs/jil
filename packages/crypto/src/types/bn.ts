...
export interface BN {
  ...
  from(num?: number | bigint | string | boolean | object, base?: number | string, endian?: string): this;
}
...
export interface BNCtor {
  ...
  wordSize: number;
  Red: RedCtor;
  new (num: number | bigint | string | object | boolean, base?: number | string, endian?: string): BN;
