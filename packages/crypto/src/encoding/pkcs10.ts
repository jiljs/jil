...
export namespace pkcs10 {
  ...
  export class CertificationRequest extends asn1.Sequence {
    ...
    clean() {
      return this.certificationRequestInfo.clean() && this.signatureAlgorithm.clean() && this.signature.clean();
    }
  ...
  export class CertificationRequestInfo extends asn1.Sequence {
    ...
    clean() {
      return (
        this.version.clean() && this.subject.clean() && this.subjectPublicKeyInfo.clean() && this.attributes.clean()
      );
    }
