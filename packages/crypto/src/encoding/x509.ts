...
export namespace x509 {
  ...
  export class AlgorithmIdentifier extends asn1.Sequence {
    ...
    constructor(algorithm?: number | number[] | Buffer | Uint32Array | string, parameters?: asn1.Node) {
      super();
  ...
  export class RDN extends asn1.Set {
    ...
    constructor(id?: string | number | number[] | Buffer | Uint32Array, value?: asn1.Node) {
      super();
    ...
    getBodySize() {
      ...
      expect(this.attributes.length >= 1).toBeTruthy();
  ...
  export class DigestInfo extends asn1.Sequence {
    ...
    constructor(algorithm?: string | number | number[] | Buffer | Uint32Array, digest?: Buffer) {
      super();
