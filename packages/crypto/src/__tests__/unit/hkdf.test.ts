...
const vectors: any[] = [
  // https://tools.ietf.org/html/rfc5869
  {
    ...
    okm: Buffer.from(
      '' + '3cb25f25faacd57a90434f64d0362f2a2d2d0a90' + 'cf1a5a4c5db02d56ecc4c5bf34007208d5b887185865',
      'hex',
    ),
  },
  {
    ...
    len: 82,
    prk: Buffer.from('' + '06a6b88c5853361a06104c9ceb35b45c' + 'ef760014904671014a193f40c15fc244', 'hex'),
    okm: Buffer.from(
      '' +
  ...
  },
  {
    ...
    info: null,
    len: 42,
    prk: Buffer.from('19ef24a32c717b167f33a91d6f648bdf96596776afdb6377ac434c1c293ccb04', 'hex'),
    okm: Buffer.from(
...
describe('HKDF', function () {
  for (const [i, vector] of vectors.entries()) {
    ...
    it(`should do hkdf (${i + 1})`, () => {
      ...
      expect(prk1).toEqual(prk);
      expect(okm1).toEqual(okm);
    });
