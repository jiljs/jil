...
export function useListNavigation(list: {disabled?: boolean; divider?: boolean}[], defaultIndex?: number) {
  ...
  const [highlightedIndex, setHighlightedIndex] = useState(() => defaultIndex ?? getNextIndex(0, 1));
