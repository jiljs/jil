...
import {Arg, Command, INTERNAL_PROGRAM} from '..';
import {mockProgram, mockStreams, runCommand} from '../mocks';
...
import {Child, GrandChild, Parent, UnknownChild, UnknownGrandChild} from './__fixtures__/commands';
...
describe('Command', () => {
  ...
  describe('decorators', () => {
    ...
    it('sets params with @Arg.Params', () => {
      ...
      expect(params).toEqual([{description: 'Package name', label: 'pkg', required: true, type: 'string'}]);
    });
