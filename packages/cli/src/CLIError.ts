...
const errors = {
  ...
  COMMAND_INVALID_REGISTER: 'Invalid command type being registered. Must be a command instance with a `run()` method.',
  ...
  THEME_UNKNOWN: 'Theme could not be loaded. Attempted `@jil/theme-{0}` and `jil-theme-{0}`.',
};
