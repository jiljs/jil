import {ContextFactory, ParseError, parseInContext, ParserOptions} from '..';
import {flagConfig, numConfigExpanded, numsConfig, optConfig, optsConfigArity} from './__fixtures__/options';
...
describe('parseInContext()', () => {
  ...
  it('returns different arguments based on context factory', () => {
    ...
    const barResult = parseInContext<BarOptions>(['bar', '--nums', '1', '2', '-nn', '--nums', '3'], contextFactory);
