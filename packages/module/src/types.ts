...
export type LoaderDefaultResolve = (specifier: string, context: ResolveContext) => Promise<ResolveResult>;
...
export type LoaderLoad = (url: string, context: LoadContext, defaultLoad: LoaderDefaultLoad) => Promise<LoadResult>;
...
export type LoaderDefaultGetFormat = (url: string, context: GetFormatContext) => Promise<GetFormatResult>;
